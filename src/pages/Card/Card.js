...
import {Link as AVMfail} from '@material-ui/core';
  ...
  <div>
    <div className={c.grow}>
      <AppBar position="static">
        <Toolbar>
        <AVMfail href="/" style={{color: 'white', textDecoration: 'none'}}>
            <Typography className={classes.title} variant="h6" noWrap>
              {/* Grapher-Mart */}
              <img src={logo} alt='Not working' height='60'/>
            </Typography>
          </AVMfail>
          <div className={c.search} style={{marginLeft: '42vw'}}>
    ...
    <div style={{backgroundColor: 'white', marginTop: '3vh', height: '30vh', marginLeft: '-1vw', maxWidth: '18vw'}} className={cl.root}>
      ...
      <Grid item xs={12}>
          <Paper className={cl.paper}>
            <div style={{width: '15vw', display:'inline-block', marginLeft: '1vw', paddingTop: '2vh', paddingBottom: '2vh'}}>
            ...
            <div style={{width: '17vw', display:'inline-block', marginLeft: '0vw', verticalAlign: 'top', marginTop: '2vh'}}>
    ...
    <div style={{marginRight: '2vw', marginLeft: '1vw'}} className={classes.root}>
        ...
        {   docdata.length?
            ...
            <div style={{display: 'block'}}>
              <div style={{marginTop:'1vh', marginLeft: '1vw', height: '5vh', width: '20vw'}}><h1>Sample Work</h1></div>
              <div style={{marginLeft: '1.2vw', marginTop: '3vh', width: '61vw', textAlign: 'left'}}>
    ...
    return(
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Button variant='outlined' style={{color: 'white', backgroundColor: 'rgba(92, 107, 192, 1)', marginLeft: '70vw'}} onClick={e => setLoginpage(false)}>Back</Button>
          <div className={c.grow} />
        </Toolbar>
      </AppBar>
    </div>
        <Grid container spacing={0.5}>
          <Grid item xs={4} style={{marginLeft: '33vw'}}>
